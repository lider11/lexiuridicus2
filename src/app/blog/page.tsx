...
export default async function BlogPage() {
  ...
  const categories = ["Tradicion de acciones", "Imagen empresarial", "Gobierno corporativo"];
    ...
    <main className="site-shell">
      ...
      <section className="blog-hero">
        <div className="blog-hero-copy">
          ...
          <h1>Lecturas para ordenar tu empresa antes de una decision importante.</h1>
          <p>
            Guias practicas sobre acciones, imagen empresarial y gobierno corporativo para empresarios que quieren
            anticipar riesgos, preparar conversaciones y proyectar confianza.
          </p>
          <div className="service-pills blog-category-pills" aria-label="Categorias del blog">
      ...
      <section className="section topics-section">
        ...
        <div className="topic-grid">
          <article>
            ...
            <p>Lecturas para entender titularidad, trazabilidad y riesgos en la propiedad accionaria.</p>
          </article>
          <article>
            <strong>Imagen empresarial</strong>
            <p>Guias para presentar la empresa con mayor claridad ante inversionistas, aliados o compradores.</p>
          </article>
          <article>
            <strong>Gobierno corporativo</strong>
            <p>Contenido sobre reglas, roles y decisiones internas para empresas en crecimiento.</p>
          </article>
        </div>
      </section>
      ...
      <section className="section final-cta">
        <div>
          ...
          <h2>Si identificaste un riesgo en tu empresa, conviene diagnosticarlo antes de que crezca.</h2>
          <p>Podemos ayudarte a priorizar acciones, imagen empresarial o gobierno corporativo segun tu situacion.</p>
        </div>
