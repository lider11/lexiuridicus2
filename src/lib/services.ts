...
export const servicePages: ServicePage[] = [
  {
    ...
    problem:
      "La empresa tiene transferencias, acuerdos o registros accionarios que no cuentan una historia completa.",
    benefit:
      "Socios, administradores e inversionistas ganan claridad sobre titularidad, soportes y riesgos de propiedad.",
    intro:
  ...
  },
  {
    ...
    problem:
      "La informacion corporativa no comunica orden, coherencia ni preparacion frente a inversionistas o aliados.",
    benefit:
      "La empresa proyecta mayor confianza externa con documentos, narrativa y riesgos visibles mejor organizados.",
    intro:
  ...
  },
  {
    ...
    problem:
      "Roles, organos y decisiones importantes dependen de practicas informales o soportes incompletos.",
    benefit:
      "La empresa mejora continuidad, control interno y confianza entre socios con reglas mas claras.",
    intro:
